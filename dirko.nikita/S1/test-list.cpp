...
BOOST_AUTO_TEST_CASE(test_emplace_back)
{
  ...
  BOOST_CHECK_EQUAL(list.size(), 1);
  BOOST_CHECK_EQUAL(list.tail().first, 10);
  BOOST_CHECK_EQUAL(list.tail().second, "hello");
}
...
BOOST_AUTO_TEST_CASE(test_emplace_front)
{
  ...
  BOOST_CHECK_EQUAL(list.size(), 1);
  BOOST_CHECK_EQUAL(list.head().first, 20);
  BOOST_CHECK_EQUAL(list.head().second, "front");
}
...
BOOST_AUTO_TEST_CASE(test_emplace_move)
{
  ...
  BOOST_CHECK_EQUAL(list.size(), 1);
  BOOST_CHECK_EQUAL(list.tail(), "move_string");
}
